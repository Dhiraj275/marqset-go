...
if( ! empty( $_POST['email'] ) ) {
	...
	$receiver_email = 'dhirajprajapati.co@gmail.com';
	...
	if( $enable_smtp == 'no' ) { // Simple Email
		...
		$mail->isSMTP();
		$mail->Host     = 'smtp.zoho.com'; // Your SMTP Host
		$mail->SMTPAuth = true;
		$mail->Username = 'brandstrategysolution@marqset.com'; // Your Username
		$mail->Password = 'ZVW0yj6hfEYr'; // Your Password
